...
label=Label(w,textvariable=equation_label,font=("consolas",20),bg="white",width=24,height=2)
label.pack()
...
clear=Button(w,text="clear",height=4,width=12,font=35,command=clear)
clear.pack()
